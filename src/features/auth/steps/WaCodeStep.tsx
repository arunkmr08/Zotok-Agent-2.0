...
export function WaCodeStep({ waPhone, setStep }: Props) {
  return (
    <div className="flex flex-col gap-5">
      ...
      >
        <button className="text-[13px] text-[#111] dark:text-white underline underline-offset-[2px] font-semibold hover:text-[#0067ff] dark:hover:text-[#0067ff] transition-all mb-2" onClick={() => setStep("wa-connect")}>Login With QR Code</button>
        <button
