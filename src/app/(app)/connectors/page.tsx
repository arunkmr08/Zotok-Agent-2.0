      ...
      <div className="h-full overflow-y-auto bg-[#f9f9f9] dark:bg-[#111]">
        ...
        <div className="bg-gradient-to-r from-white to-[#ebfff7] dark:from-[#141414] dark:to-[#0d1f18] px-[80px] py-[52px] flex items-center gap-[60px]">
          <div className="flex-1 flex flex-col gap-[16px]">
            ...
            {/* Tag */}
            <motion.div {...fadeUp(0)} className="self-start flex items-center gap-[4px] bg-[#eaf8f2] border border-[#ccefe0] rounded-[8px] px-[8px] py-[6px]">
            ...
            {/* Subtext */}
            <motion.p {...fadeUp(0.12)} className="font-normal text-[16px] text-[#595959] dark:text-[#8c8c8c] tracking-[-0.18px] leading-[26px] max-w-[440px]">
              Automatically sync products, customers, invoices, payments and orders from the tools your team already uses.
            </motion.p>

            {/* Feature chips */}
            <motion.div {...fadeUp(0.17)} className="flex items-center gap-[10px] flex-wrap">
            ...
            {/* CTA */}
            <motion.div {...fadeUp(0.21)} className="pt-[4px]">
          ...
          {/* Hero illustration */}
          <motion.div {...fadeUp(0.1)} className="flex-shrink-0 w-[507px] h-[338px]">
            <Image
        ...
        <div className="flex flex-col py-[60px]">
          <motion.p {...fadeUp(0)} className="font-semibold text-[18px] text-[#262626] dark:text-white tracking-[-0.3px] px-[80px] pb-[20px]">
            All Connectors
          </motion.p>
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-[16px] px-[80px] pb-[40px]">
            {state.connectors.map((connector, i) => (
              <motion.div key={connector.key} {...fadeUp(0.06 + i * 0.07)}>
                <ConnectorCard
                  connector={connector}
